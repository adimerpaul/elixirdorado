...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // Conexión CENTRAL (para el administrador)
        'central' => [
            'driver' => 'mysql',
            'url' => env('DB_URL'),
            'host' => env('DB_CENTRAL_HOST', env('DB_HOST', '127.0.0.1')),
            'port' => env('DB_CENTRAL_PORT', env('DB_PORT', '3306')),
            'database' => env('DB_CENTRAL_DATABASE', env('DB_DATABASE', 'elixir_central')),
        ...
        // Conexión TENANT (para las sucursales - se asigna dinámicamente)
        'tenant' => [
            'driver' => 'mysql',
            'url' => env('DB_URL'),
            'host' => env('DB_TENANT_HOST', '127.0.0.1'),
            'port' => env('DB_TENANT_PORT', '3306'),
            'database' => '', // Se llenará en tiempo de ejecución
        ...
        // Conexión por defecto (apunta a central)
        'mysql' => [
            'driver' => 'mysql',
            'url' => env('DB_URL'),
            'host' => env('DB_CENTRAL_HOST', env('DB_HOST', '127.0.0.1')),
