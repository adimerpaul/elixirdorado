...
<head>
    ...
    <title><?php echo e($producto->nombre); ?> · Elixir Dorado</title>
    <meta name="description" content="Compra <?php echo e($producto->nombre); ?> por Bs. <?php echo e(number_format($producto->precio_venta, 0)); ?> en Elixir Dorado. <?php echo e($producto->categoria_nombre ?? 'Bebidas premium'); ?> con envío rápido en Bolivia.">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="<?php echo e(url('/producto/' . $producto->id)); ?>">

    
    <meta property="og:type" content="product">
    <meta property="og:title" content="<?php echo e($producto->nombre); ?> · Elixir Dorado">
    <meta property="og:description" content="Bs. <?php echo e(number_format($producto->precio_venta, 0)); ?> — <?php echo e($producto->categoria_nombre ?? 'Bebidas Premium'); ?> — Elixir Dorado">
    <?php if(!empty($producto->imagen)): ?>
    <meta property="og:image" content="<?php echo e(asset('storage/' . $producto->imagen)); ?>">
    <?php endif; ?>
    <meta property="og:url" content="<?php echo e(url('/producto/' . $producto->id)); ?>">
    <meta property="og:site_name" content="Elixir Dorado">

    
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?php echo e($producto->nombre); ?> · Elixir Dorado">
    <meta name="twitter:description" content="Bs. <?php echo e(number_format($producto->precio_venta, 0)); ?> en Elixir Dorado">
    <?php if(!empty($producto->imagen)): ?>
    <meta name="twitter:image" content="<?php echo e(asset('storage/' . $producto->imagen)); ?>">
    <?php endif; ?>
...
$value = context()->get($__contextArgs[0]); ?>": "https://schema.org",
        "@type": "Product",
        "name": "<?php echo e(addslashes($producto->nombre)); ?>",
        "description": "<?php echo e(addslashes($producto->categoria_nombre ?? 'Bebida premium')); ?> disponible en Elixir Dorado",
        <?php if(!empty($producto->imagen)): ?>
        "image": "<?php echo e(asset('storage/' . $producto->imagen)); ?>",
        <?php endif; ?>
        "brand": { "@type": "Brand", "name": "Elixir Dorado" },
        "offers": {
            "@type": "Offer",
            "priceCurrency": "BOB",
            "price": "<?php echo e($producto->precio_venta); ?>",
            "availability": "https://schema.org/InStock",
            "url": "<?php echo e(url('/producto/' . $producto->id)); ?>"
        }
    }
    </script>
    ...
    <div class="detail-wrapper">
        ...
        <div>
            <?php if(!empty($producto->categoria_nombre)): ?>
                <div class="product-cat-badge"><?php echo e($producto->categoria_nombre); ?></div>
            <?php endif; ?>

            <h1 class="product-title gold-text"><?php echo e($producto->nombre); ?></h1>

            <div class="product-price-big">Bs. <?php echo e(number_format($producto->precio_venta, 0)); ?></div>

            <?php if($producto->stock_actual <= 5): ?>
                <div class="stock-pill low">
                    <i class="fas fa-exclamation-circle text-xs"></i>
                    <?php echo e($producto->stock_actual); ?> <?php echo e($producto->stock_actual === 1 ? 'unidad disponible' : 'unidades disponibles'); ?>
...
<script>
// ── Datos del producto ──────────────────────────────────────────────
const PRODUCTO_ID    = <?php echo e($producto->id); ?>;
const PRODUCTO_NOMBRE = '<?php echo e(addslashes($producto->nombre)); ?>';
const PRODUCTO_PRECIO = <?php echo e($producto->precio_venta); ?>;
const STOCK_MAX       = <?php echo e($producto->stock_actual); ?>;
...
function enviarPorWhatsApp() {
    ...
    const url = 'https://wa.me/<?php echo e($whatsapp); ?>?text=' + encodeURIComponent(msg);
